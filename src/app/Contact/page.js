...
export default function Page() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm("service_aw8frv1", "template_t0wvz7c", form.current, "9PXgQmNrARA8aN6P4")
      .then(() => {
        Swal.fire({
          icon: "success",
          title: "Message Sent!",
    ...
    <div className="container mx-auto px-4 sm:px-6 md:px-10 text-black mt-6 sm:mt-10">
      ...
      <div className="border-l-4 border-green-500 mb-10 sm:mb-20 pl-4 sm:pl-6">
        ...
        <p className="text-sm sm:text-base md:text-lg text-gray-500 py-1 sm:py-2">
          One is entitled to enjoy rights without obstruction, except as limited by law.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 mb-20">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          ...
          <form ref={form} onSubmit={sendEmail} className="flex flex-col gap-4">
            <input
              ...
              required
              className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-green-500"
            />
            <input
              type="email"
              name="email"
            ...
            <textarea
              ...
              className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-green-500"
            />
            <button className="w-full bg-black text-white py-3 font-semibold hover:bg-green-700 rounded transition">
              Send Message
            </button>
          </form>
        </div>
        ...
        <div className="flex flex-col gap-6 justify-center">
          <div className="flex items-center gap-4">
            <MdMessage className="text-4xl sm:text-5xl text-green-600" />
          ...
          <div className="flex items-center gap-4 mt-6">
            <SlLocationPin className="text-4xl sm:text-5xl text-green-600" />
            <span className="text-xl sm:text-3xl font-semibold">Find Us</span>
          </div>
          <p>City University, Savar, Dhaka, Bangladesh</p>

          <div className="flex items-center gap-4 mt-6">
            <FiShare2 className="text-4xl sm:text-5xl text-green-600" />
